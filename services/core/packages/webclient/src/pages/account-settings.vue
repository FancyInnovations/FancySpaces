...
<template>
  ...
  <Dialog :shown="showDeleteDialog">
    ...
    >
      ...
      <v-card-text>
        To delete your account, please reach out to our support team (via E-Mail or our Discord server) and provide them
        with your user id and email. We will then verify your identity and proceed with the deletion.
      </v-card-text>
